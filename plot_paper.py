...
def do_beta(filename):
    ...
    plot_band(axs[1], beta_range, means['F_depth'], stds['F_depth'], label='F linear')
    plot_band(axs[1], beta_range, means['F_fit_depth'], stds['F_fit_depth'], label='F fit')
    plot_band(axs[1], beta_range, means['AA'], stds['AA'], label='AA')
    plot_band(axs[1], beta_range, means['C_depth'], stds['C_depth'], label='C')
...
def do_critical(filename):
    ...
    plt.xlabel('Number of nqubits ($n$)')
    plt.ylabel('$\\beta_c(n)$')
...
if __name__ == "__main__":
    do_beta('results/2002/weighted_maxcut/weighted_maxcut_qubits_12_maxbeta_2002_step_25_trials_1000.csv')
    ...
    do_critical(weighted_maxcut_files)
    do_fit([
        'results/2002/weighted_maxcut/weighted_maxcut_qubits_5_maxbeta_2002_step_25_trials_1000.csv',
        'results/2002/weighted_maxcut/weighted_maxcut_qubits_10_maxbeta_2002_step_25_trials_1000.csv',
        'results/2002/weighted_maxcut/weighted_maxcut_qubits_15_maxbeta_2002_step_25_trials_100.csv'
